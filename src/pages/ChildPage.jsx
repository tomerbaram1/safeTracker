...
async function sendSOS()
{
  ...
  console.log("rrrr")
  await axios.post(SERVER_URL+"/api-map/sos",{id:id,
 token:"ExponentPushToken[qHMVt-A8zOkRpYf4e4DUnC]"})
// await axios.post(SERVER_URL+"api-map/sos",{id:id,token:"ExponentPushToken[qHMVt-A8zOkRpYf4e4DUnC]"})
...
return(
  <View>
      <Text style={styles.sosMsg}>Hello Yosi</Text>
